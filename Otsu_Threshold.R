...
#### Modifications are the log10 transformation to make it suitable for larger integers as common in NGS
#### (log10 because Otsu was developped for 256-grayscale picture manipulation, and original code does not perform
####  well without log10)
